  ...
  return (
    <>
      <Page
        title={`signup`}
      ></Page>
      <Container my={3} alignItems="center" centerContent py="8">
        <Stack>
          <Box w="sm" p="8" borderRadius={10} borderColor="gray">
            <form>
              ...
              <FormControl isInvalid={formik.errors.password}>
                ...
                <InputGroup>
                  ...
                  <InputRightElement
                    children={
                    <Button fontSize="10px" colorScheme="blackAlpha" onClick={() => setPasswordVisible(!passwordVisible)} fontWeight="xs" sx={{ _hover: { cursor: 'pointer' } }}> {passwordVisible ? "hide" : "show"} </Button>
                  } 
                  />
                </InputGroup>
              ...
              <FormControl isInvalid={formik.errors.repeatPassword}>
                ...
                <InputGroup>
                  ...
                  <InputRightElement
                    children={
                      <Button fontSize="10px" colorScheme="blackAlpha" onClick={() => setrepeatPasswordVisible(!repeatPasswordVisible)} fontWeight="xs" sx={{ _hover: { cursor: 'pointer' } }}> {repeatPasswordVisible ? "hide" : "show"} </Button>
                    }
                  />
                </InputGroup>
            ...
            <Flex mt={4} justify="center">
              <Text me={2}>Or back to </Text>
              <Link href={'/auth/login'}>
                <Text>
                  <Button fontSize="md" variant="link" colorScheme="black" size="sm">
                    Login
                  </Button>
                </Text>
              </Link>
